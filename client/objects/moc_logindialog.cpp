...
QT_MOC_LITERAL(5, 37, 6), // "cancel"
QT_MOC_LITERAL(6, 44, 13), // "validateLogin"
QT_MOC_LITERAL(7, 58, 11) // "cancelLogin"

    },
    "LoginDialog\0login\0\0username\0password\0"
    "cancel\0validateLogin\0cancelLogin"
};
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->validateLogin(); break;
        case 3: _t->cancelLogin(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginDialog::cancel)) {
                *result = 1;
                return;
            }
        }
